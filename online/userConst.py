...
# Initiation
InitiationColLabels =      ['立项识别码', '项目名称', '分项名称', '项目概算', '父项立项识别码', '父项项目名称', '父项分项名称', '父项项目概算', '建设单位识别码', '建设单位名称', '代建单位识别码', '代建单位名称', '立项文件名称', '立项时间', '已分配概算', '未分配概算', '概算分配比', '概算已付款额', '概算可付余额', '概算付款比', '立项备注']
InitiationColLabels_Type = ['整数型',     '字符串型', '字符串型', '浮点型',  '整数型',        '字符串型',    '字符串型',     '浮点型',    '整数型',          '字符串型',     '整数型',        '字符串型',    '文本型',      '日期型',   '浮点型',     '浮点型',    '百分比',  '浮点型',       '浮点型',      '百分比',    '文本型']
...
# Budget
BudgetColLabels =      ['预算识别码', '预算名称', '预算周期', '预算总额', '预算已付额', '预算余额', '父项预算识别码', '父项预算名称',  '预算已付比', '预算备注']
BudgetColLabels_Type = ['整数型',     '字符串型', '字符串型', '浮点型',   '浮点型',     '浮点型',   '整数型',         '字符串型',      '百分比',     '字符串型']
