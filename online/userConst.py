...
# Initiation
InitiationColLabels =      ['立项识别码', '项目名称', '分项名称', '项目概算', '父项立项识别码', '父项项目名称', '父项分项名称', '父项项目概算', '子项数量', '项目概算上限', '建设单位识别码', '建设单位名称', '代建单位识别码', '代建单位名称', '立项文件名称', '立项时间', '已分配概算', '未分配概算', '概算分配比', '概算已付款额', '概算可付余额', '概算付款比', '立项备注']
InitiationColLabels_Type = ['整数型',     '字符串型', '字符串型', '浮点型',  '整数型',        '字符串型',    '字符串型',     '浮点型',    '整数型',   '浮点型',      '整数型',          '字符串型',     '整数型',        '字符串型',    '文本型',      '日期型',   '浮点型',     '浮点型',    '百分比',  '浮点型',       '浮点型',      '百分比',    '文本型']
...
BiddingColLabels =      ['招标识别码', '招标方式', '项目名称', '分项名称', '中标价', '中标单位名称', '项目概算', '预算控制价', '立项识别码', '建设单位识别码', '建设单位名称', '代建单位识别码', '代建单位名称', '招标单位识别码', '招标单位名称', '招标代理识别码', '招标代理单位名称', '招标文件定稿时间', '公告邀请函发出时间', '开标时间', '中标通知书发出时间', '中标单位识别码', '招标备注']
BiddingColLabels_Type = ['整数型',     '字符串型', '字符串型', '字符串型', '浮点型', '字符串型',     '浮点型',   '浮点型',     '整数型',     '整数型',       '字符串型',     '整数型',     '字符串型',    '整数型',         '字符串型',     '整数型',         '字符串型',         '日期型',           '日期型',             '日期型',   '日期型',             '整数型',         '文本型']
...
# Payment
PaymentColLabels =      ['付款识别码', '付款登记时间', '付款支付时间', '付款事由', '收款单位名称', '本次付款额', '立项识别码', '项目名称', '分项名称', '合同识别码', '合同名称', '合同类别', '合同编号', '付款批次', '付款单位识别码', '付款单位名称', '付款单位账号', '收款单位识别码', '收款单位账号', '建设单位识别码', '建设单位名称', '代建单位识别码', '代建单位名称', '招标单位识别码', '招标单位名称', '中标单位识别码', '中标单位名称', '甲方识别码', '甲方单位名称', '乙方识别码', '乙方单位名称', '丙方识别码', '丙方单位名称', '丁方识别码', '丁方单位名称', '预算识别码', '预算名称', '预算周期', '付款时预算总额', '付款时项目概算', '付款时合同付款上限', '付款时合同值', '付款时预算余额', '付款时概算余额', '付款时合同可付余额', '付款时合同未付额', '付款时预算已付额', '付款时合同已付额', '付款时概算已付额', '付款时预算已付比', '付款时合同已付比', '付款时概算已付比', '付款时形象进度', '预算本次付款比', '合同本次付款比', '概算本次付款比', '预算累付比', '合同累付比', '概算累付比', '付款备注']
PaymentColLabels_Type = ['整数型',     '日期型',       '日期型',       '文本型',   '字符串型',     '浮点型',  '整数型',    '字符串型', '字符串型', '整数型',    '字符串型', '字符串型', '字符串型', '整数型',   '整数型',         '字符串型',   '字符串型',     '整数型',       '字符串型',     '整数型',        '字符串型',    '整数型',        '字符串型',     '整数型',        '字符串型',    '整数型',        '字符串型',     '整数型',    '字符串型',    '整数型',     '字符串型',    '整数型',    '字符串型',    '整数型',     '字符串型',     '整数型',    '字符串型', '字符串型', '浮点型',        '浮点型',        '浮点型',            '浮点型',      '浮点型',       '浮点型',        '浮点型',            '浮点型',          '浮点型',         '浮点型',         '浮点型',          '百分比',          '百分比',         '百分比',         '字符串型',       '百分比',         '百分比',       '百分比',        '百分比',    '百分比',    '百分比',     '文本型']
