...
# Initiation
InitiationColLabels =      ['立项识别码', '项目名称', '分项名称', '项目概算', '父项立项识别码', '父项项目名称', '父项分项名称', '建设单位识别码', '建设单位名称', '代建单位识别码', '代建单位名称', '立项文件名称', '立项时间', '未分配概算', '概算付款比', '立项备注']
InitiationColLabels_Type = ['整数型',     '字符串型', '字符串型', '浮点型',   '整数型',         '字符串型',     '字符串型',     '整数型',         '字符串型',     '整数型',         '字符串型',     '字符串型',     '日期型',   '浮点型',     '百分比',     '文本型']
